...
class tower extends screen{
    ...
    int pegAFeetY= pegY +pegHeight-pegFeetHeight;
    int pegBFeetX=pegBX+5-(pegFeetWidth)/2;
    int pegBFeetY= pegY +pegHeight-pegFeetHeight;
    int pegCFeetX=pegCX+5-(pegFeetWidth)/2;
    int pegCFeetY= pegY +pegHeight-pegFeetHeight;
    int pegTipRadius=pegWidth+1;
    int pegATipX=pegAX-1;
    int pegATipY= pegY -pegTipRadius/2;
    int pegBTipX=pegBX-1;
    int pegBTipY= pegY -pegTipRadius/2;
    int pegCTipX=pegCX-1;
    int pegCTipY= pegY -pegTipRadius/2;
}
...
public class Window extends JFrame {
    ...
    public void drawPegs(Graphics g){
        ...
        // Peg A
        g.fillRect(tow.pegAX,tow.pegY,tow.pegWidth,tow.pegHeight);
        ...
        // Peg B
        g.fillRect(tow.pegBX,tow.pegY,tow.pegWidth,tow.pegHeight);
        ...
        // Peg C
        g.fillRect(tow.pegCX,tow.pegY,tow.pegWidth,tow.pegHeight);
